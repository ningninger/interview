...
> Lexical analysis -> Syntax analysis -> Semantic analysis -> Intermediate code generation -> Intermediate code optimization -> Code generation
...
在词法分析的基础上，将单词流**按照语法规则组合成各种类型的语法短语**，如程序，语句，表达式等，检查是否存在不满足语法规则的单词流，语法规则使用上下文无关语法描述
